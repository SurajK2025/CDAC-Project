...
CREATE TABLE `cart_course` (
  ...
  KEY `FK80tsn9bdrd52nhwkruj5hx9fw` (`course_id`),
  KEY `FK24qd7ebrcs4hbo5qu5spgwfvh` (`cart_id`),
  CONSTRAINT `FK24qd7ebrcs4hbo5qu5spgwfvh` FOREIGN KEY (`cart_id`) REFERENCES `carts` (`id`),
  CONSTRAINT `FK80tsn9bdrd52nhwkruj5hx9fw` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`)
