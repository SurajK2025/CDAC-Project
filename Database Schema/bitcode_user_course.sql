...
CREATE TABLE `user_course` (
  ...
  KEY `FKoc4yl478i6o8hf240vumhjgrb` (`user_id`),
  CONSTRAINT `FKf4qni5wnlq0x70fm39w9tv7x4` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`),
  CONSTRAINT `FKoc4yl478i6o8hf240vumhjgrb` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `user_course` VALUES (1,2),(1,1),(1,3),(3,1),(3,2),(4,1),(5,1),(5,2);
